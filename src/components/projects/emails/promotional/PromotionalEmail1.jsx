                  ...
                  <tr>
                      <td>
                          ...
                          <table className="container" width={600} align="center" cellSpacing={0} cellPadding={0} border="0">
                              ...
                              <tbody>
                                  <tr>
                                      <td style={{fontFamily:'Open Sans', sansSerif: true,color:'white',backgroundColor:'#fafafa'}} >
                                          {/* <!--Start Left column--> */}
                                          <table className="header-left" width="50%" align="left" cellSpacing={0} cellPadding={0} border="0" 
                                          style={{ background: 'linear-gradient(90deg, rgba(101,255,253,1) 0%, rgba(34,150,238,1) 100%)', padding: '18px 18px 70px 18px' }}>
                                            <tbody>
                                                <tr>
                                                  <td>
                                                    <i className="fa-solid fa-h top-logo" style={{ padding: '5px', border: '2px solid black', backgroundColor: 'white', color: 'rgba(101,255,253,1)', margin: '2px', borderRadius: '5px' }}></i>
                                                    <h2 style={{ padding: '25px 0px', fontSize: '30px', fontWeight: 300 }}>
                                                      Get ready for
                                                    </h2>
                                                    <h1 style={{ fontSize: '80px', fontWeight: 600, lineHeight: 0, padding: '0px', margin: '10px 0px' }}>
                                                      Hero
                                                    </h1>
                                                    <p style={{ lineHeight: 1.5, fontStyle: 'italic', fontSize: '16px', padding: '34px 0px 50px' }}>
                                                      It seems like hundreds of new iWatch apps pop up every week, but which ones should you bother trying?
                                                    </p>
                                                    <a href="#" className="ghost-btn" style={{ fontSize: '12px', borderRadius: '3px', border: '2px solid white', textDecoration: 'none', color: 'white', padding: '10px 15px', fontWeight: '600', textTransform: 'uppercase' }}>
                                                      Learn More
                                                    </a>
                                                  </td>
                                                </tr>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <table className="menu-table--container" width="100%" align="center" cellSpacing={0} cellPadding={0} border="0" style={{ padding: '10px 0' }}>
                                                            <tbody>
                                                              <tr>
                                                                <td style={{ fontFamily:'Open Sans', sansSerif: true }}>
                            ...
                            {/*   <!--End of header row-->
                              ...
                              <td className="lets-you-row" style={{ backgroundColor: '#fafafa' }}>
                                      <h3 align="center" style={{ fontFamily: 'Open Sans', sansSerif: true, fontSize: '1.6rem', fontWeight: 300, textTransform: 'uppercase' }}>
                                        Hero lets you...
                                      </h3>
                                      ...
                                      style={{ padding: '18px 18px 70px 25px' }}>
                                        <tbody>
                                            <tr>
                                              <td>
                                                <table className="title-icon" width="100%" cellSpacing={0} cellPadding={0} border="0" style={{ padding: '18px 10px' }}>
                                                  <tr style={{ fontFamily: 'Open Sans', sansSerif: true }}>
                                                    <td>
                                                      <i className="fa-solid fa-bell"></i>
                                                    </td>
                                                    <td style={{ fontWeight: 600, color: '#333333', padding: '0 0', textTransform: 'uppercase', fontSize: '14px' }}>
                                                      Notify
                                                    </td>
                                                  </tr>
                                                </table>
                                            ...
                                            <tr>
                                              <td>
                                                <p style={{ fontFamily: 'Open Sans', sansSerif: true }}>Lorem ipsum cras notificator</p>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td>
                                                <a href="#" style={{ fontWeight: 600, color: '#2792ec', fontSize: '14px', textDecoration: 'none' }}>Learn More</a>
                                              </td>
                                            </tr>
                                          </tbody>
                                      </table>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style={{ display: 'flex', justifyContent: 'center' }}>
                                              ...
                                              style={{ backgroundColor: 'rgb(253, 169, 169)', width: '460px', height: '200px', marginTop: '50px' }} border="0" align="center">
                                              </div>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td style={{ display: 'flex', justifyContent: 'center' }}>
                                              <p align="center" style={{ width: '70%', fontFamily: 'Open Sans', sansSerif: true, fontSize: '27px', fontWeight: 300, marginTop: '60px' }}>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style={{ padding: '10px' }}>
                                              <p style={{ width: '100%', fontFamily: 'Open Sans', sansSerif: true, fontSize: '12px', fontWeight: 300, lineHeight: 1.7, padding: '0 0 20px' }}>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td className="google-play-button">
                                              <img src="https://cdn.freebiesupply.com/logos/large/2x/get-it-on-google-play-logo-png-transparent.png" style={{ width: '100px', border: '1px solid black', borderRadius: '5px', marginTop: '1px', padding: '0 5px' }} />
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                            ...
                            {/*   <!--End of advance row-->
                              ...
                              <tr>
                                  <td style={{backgroundColor:'white'}}>
                                    ...
                                    style={{ padding: '18px 18px 20px 18px', backgroundColor: '#141414', marginBottom: '20px' }}>
                                      <tbody>
                                        <tr>
                                          <td style={{ width: '100%' }}>
                                            <h1 style={{ fontFamily: 'Open Sans', sansSerif: true, fontSize: '20px', fontWeight: 300, color: 'white', textAlign: 'center' }}>
                                              One App,<span style={{ fontWeight: 500 }}> One Solution</span>
                                            </h1>
                                          </td>
                                        </tr>

                                        <tr style={{ color: 'white', fontFamily: 'Open Sans', sansSerif: true, fontSize: '12px', marginTop: '20px', display: 'flex', justifyContent: 'space-around' }}>
                                          <td>
                            ...
                            {/*  <!--End of one solution row-->
                              ...
                              <tr>
                                  <td>
                                    ...
                                    style={{ padding: '18px 18px 70px 18px', backgroundColor: 'white', fontFamily: 'Open Sans', sansSerif: true }}>
                                        <tbody>
                                          <tr>
                                              <td align="center">
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td align="center">
                                                          ...
                                                          style={{ width: '100px', height: '100px', backgroundColor: 'pink', borderRadius: '10px', margin: '15px 0' }}>
                                                          </div>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                        <td align="center">
                                                          <p style={{ fontWeight: '400', fontSize: '13px', lineHeight: '1.6', color: '#3d3d3d', marginTop: '-1px' }}>
                              ...
                              <tr>
                                  <td>
                                      ...
                                      style={{backgroundColor: '#fafafa',fontFamily: 'Open Sans', sansSerif: true}}>
                                        <tbody>
                                        {/*  <!--First Row--> */}
                                            <tr> 
                                                <td>
                              ...
                              <tr>
                                  <td>
                                      ...
                                      style={{ color: 'white', background: 'linear-gradient(135deg, rgba(101,255,253,1) 0%, rgba(34,150,238,1) 90%)', fontFamily: 'Open-Sans, sans-serif', padding: '65px 0' }}>
                                          <tbody>
                                              <tr>
                                                  <td align="center">
                                              ...
                                              <tr>
                                                  <td align="center" style={{padding:'30px 0'}}>
                                                      ...
                                                      style={{ fontSize: '12px', borderRadius: '3px', border: '2px solid white', textDecoration: 'none', color: 'white', padding: '10px 15px', fontWeight: 600, textTransform: 'uppercase' }}>
                                                      Request a Quote
                                                      </a>
                                                  </td>
                                              </tr>
                              ...
                              <tr>
                                  <td>
                                      <table width="100%" className="footer-table" 
                                        style={{ color: 'black', backgroundColor: '#fafafa', fontFamily: "'Open-Sans', sans-serif", padding: '20px 0' }}>
                                          <tbody>
                                              <tr>
                                                  <td align="center">
