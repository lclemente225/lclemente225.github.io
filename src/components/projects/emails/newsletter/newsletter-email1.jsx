              ...
              <td>
                <table className="container" align="center" border={0} width={600} cellSpacing={0} cellPadding={0}
                  ...
                  <tbody>
                    <tr>
                      <td align="center">
                        <img src="/newsletter-assets/fashion-nova-top-logo.png" alt="fashion-nova-logo"
                        className="fashion-nova-logo"
                        style={{ height: '50px' }} />
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <table className="nav-container" align="center" border={0} width="60%" cellSpacing={0} cellPadding={0}
                          style={{ 
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <a href="#" className="nav-links-top"
                                    style={{ 
                      ...
                      <td>
                        <table align="center" border={0} width="100%" cellSpacing={0} cellPadding={0}
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <p className="newsletter-free-shipping-text" 
                                  style={{ 
                                         textTransform: 'uppercase', 
                                         textDecoration: 'none', 
                                         textAlign: 'center', 
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <a href="#">
                          <img src="/newsletter-assets/veterans-day-img.jpg" alt="Veterans Day Sale 40% Off SiteWide" 
                          className="newsletter-image-asset"
                          style={{ width: '100%' }} />
                        </a>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <a href="#">
                          <img src="/newsletter-assets/fashion-nova-curve.jpg" alt="Curve Sale 40% Off SiteWide" 
                          className="newsletter-image-asset"
                          style={{ width: '100%' }} />
                        </a>
                      </td>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <a href="#">
                          <img src="/newsletter-assets/fashion-nova-men.jpg" alt="Men Sale 40% Off SiteWide" 
                          className="newsletter-image-asset"
                          style={{ width: '100%' }} />
                        </a>
                      </td>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <a href="#">
                          <img src="/newsletter-assets/quadpay-info.jpg" alt="QuadPay Info"
                          className="newsletter-image-asset" 
                          style={{ width: '100%' }} />
                        </a>
                      </td>
                      ...
                      <td>
                        ...
                        <table width="100%" cellSpacing={0} cellPadding={0} border={0} style={{ marginBottom: '15px' }}>
                          <tbody>
                            <tr>
                              <td>
                                <img src="/newsletter-assets/apple-app-store-button.jpg" alt="App Store Button" align="right" 
                                style={{ height: '32px' }} />
                              </td>
                              <td>
                                <img src="/newsletter-assets/google-play-button.jpg" alt="Google Play Button" align="left" 
                                style={{ height: '32px' }} />
                              </td>
                            </tr>
                          </tbody>
                          ...
                          <tbody>
                            <tr align="center">
                              <td>
                                ...
                                className="newsletter-social-links"
                                style={{ width: '32px' }} />
                              </td>
                              <td>
                              ...
                              <td>
                                <img src="/newsletter-assets/referral-price.jpg" alt="refer a friend" 
                                className="newsletter-referral link"
